...
Bars & Food:
L’Ovella Negra beer garden, Razzmatazz club, Gelato collection, Petit tapas

Things to do:
El mural del besto, Sagrada familia, Casa batllo. Cathedral, Gothic quarter
...
function preload() {
  ...
  //BACKGROUND IMAGE
  bgImg = loadImage('img/barcelona.png');

  // IMAGE ARRAY
  // These images cycle when the user clicks the main image
  pictures[0] = loadImage("img/barcelonapic1.png");
  pictures[1] = loadImage("img/barcelonapic2.png");
  pictures[2] = loadImage("img/barcelonapic3.png");
