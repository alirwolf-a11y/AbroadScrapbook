...
Bars & Food:
Havana club, Footloose club, Toy room, Social fun bar, dr juice, Bacconcino cafe

Things to do:
boat tour, Blue lagoon, Explore gozo, Upper barraka gardens, Lascaris war rooms, Old prison, Water taxi
...
function preload() {
  ...
  //BACKGROUND IMAGE
  bgImg = loadImage('img/malta.png');

  // IMAGE ARRAY
  // These images cycle when the user clicks the main image
  pictures[0] = loadImage("img/maltapic1.png");
  pictures[1] = loadImage("img/maltapic2.png");
  pictures[2] = loadImage("img/maltapic3.png");
  pictures[3] = loadImage("img/maltapic4.png");
