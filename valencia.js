...
Bars & Food:
Unic daily goodness, La cola del pez, AmaMi, Boa beach, mercat central

Things to do:
silk trade, Valencia cathedral, Go to the beach
...
function preload() {
  ...
  //BACKGROUND IMAGE
  bgImg = loadImage('img/valencia.png');

  // IMAGE ARRAY
  // These images cycle when the user clicks the main image
  pictures[0] = loadImage("img/valenciapic1.png");
  pictures[1] = loadImage("img/valenciapic2.png");
  pictures[2] = loadImage("img/valenciapic3.png");
