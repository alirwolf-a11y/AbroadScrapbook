...
Bars & Food:
Reverse, The Florence Irish pub, Buchette Del vino (wine window), Acqua Al 2, Coffee mantra, Osteria de Pitti, Bottegone, Gelato, Hario coffee factory 

Things to do:
Basilica of Santa Croce, Palazzo Vecchio, Duomo, Florence Leather market real, Accademia gallery (to see David), Santo spirito market
...
function preload() {
  ...
  //BACKGROUND IMAGE
  bgImg = loadImage('img/florence.png');

  // IMAGE ARRAY
  // These images cycle when the user clicks the main image
  pictures[0] = loadImage("img/florencepic1.png");
  pictures[1] = loadImage("img/florencepic2.png");
  pictures[2] = loadImage("img/florencepic3.png");
  pictures[3] = loadImage("img/florencepic4.png");
  pictures[4] = loadImage("img/florencepic5.png");
  pictures[5] = loadImage("img/florencepic6.png");
